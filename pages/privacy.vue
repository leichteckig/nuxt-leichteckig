<template>
  <Page title="Data Protection">
    <main class="index">
      <section>
        <div class="data-protection__inner">
          <div class="data-protection__text">
            <p class="data-protection__sub-title">English translation below. <span class="hint">Jump to the <a class="index-link" href="#mEnglish">translation</a> directly</span></p>
          </div>
        </div>
        <div class="gradient"></div>
        <div class="handdraw-line"></div>
      </section>
      <section class="data-protection--german">
        <h2 id="#germanDp">🇩🇪 Datenschutzerklärung</h2>
        <h2>Einleitung</h2>
        ...
        <p>Ramona Schwering<br>Hochstraße 67<br>42105 Wuppertal</p>
        <p>E-Mail-Adresse: hello@<span class="mail">schwering</span>ramona.codes<br/></p>
...
<!--          <li>Feedback (z.B. Sammeln von Feedback via Online-Formular).</li>-->
        ...
        <p>Um unser Onlineangebot sicher und effizient bereitstellen zu können, nehmen wir die Leistungen von einem oder
          ...
          technische Wartungsleistungen in Anspruch nehmen. Die Erfassung der Daten zur
          Bereitstellung und Nutzung der Website und die Verarbeitung der Daten über einen externen
          Hosting-Dienstleister ist für den Betrieb der Internetseite zwingend erforderlich. Rechtsgrundlage für die
          Verarbeitung ist Art. 6 Abs. 1 S. 1 lit. f DSGVO.</p>
        ...
        <p>Für das Hosting unserer Webseite verwenden wir momentan die Dienste von www.netlify.com (Netlify, Inc., 2325
          3rd Street, Suite 215, San Francisco, 94107 CA). Die Server von Netlify befinden sich in den USA. Deshalb
          werden Ihre Daten, die für den Aufruf der Webseite benötigt werden (Zugriffsdaten), in die USA übermittelt.
          Rechtsgrundlage für die Übermittlung ist Art. 6 Abs. 1 S. 1 lit. f DSGVO.

          Um den Schutz Ihrer Persönlichkeitsrechte auch im Rahmen dieser Datenübertragungen zu gewährleisten, bedienen
          wir uns bei der Ausgestaltung der Vertragsverhältnisse mit Netlify der Standardvertragsklauseln der
          EU-Kommission gemäß Art. 46 Abs. 2 lit. c) DSGVO. Diese sind unter
          https://www.netlify.com/legal/netlify-dpa.pdf abrufbar, alternativ können Sie diese Dokumente auch bei uns
          unter den unten angegebenen Kontaktmöglichkeiten erfragen.

          Sie können gegen die Verarbeitung jederzeit Widerspruch einlegen. Beachten sie hierzu die obigen Hinweise zu
          Ihrem Widerspruchsrecht dieser Datenschutzerklärung. Sie können sich mit Ihrem Widerspruch
          sowohl an uns als auch direkt an Netlify wenden.</p>
        ...
        <p><strong>Kommentare und Beiträge</strong>: Wenn Nutzer Kommentare oder sonstige Beiträge hinterlassen, können
        ...
        <p>Des Weiteren behalten wir uns vor, auf Grundlage unserer berechtigten Interessen die Angaben der Nutzer
          zwecks Spamerkennung zu verarbeiten.</p>
        ...
        <ul class="m-elements">
          ...
          <li><strong>Betroffene Personen:</strong> Nutzer (z.B. Webseitenbesucher, Nutzer von Onlinediensten).</li>
          <li><strong>Zwecke der Verarbeitung:</strong> Erbringung vertraglicher Leistungen und Kundenservice, Feedback
            (z.B. Sammeln von Feedback via Online-Formular), Sicherheitsmaßnahmen, Verwaltung und Beantwortung von
            Anfragen.
          </li>
        ...
        <p>Für eine detaillierte Darstellung der jeweiligen Verarbeitungsformen und der Widerspruchsmöglichkeiten
          (Opt-Out) verweisen wir auf die Datenschutzerklärungen und Angaben der Betreiber der jeweiligen Netzwerke.</p>
        ...
        <ul class="m-elements">
          <li><strong>LinkedIn:</strong> Soziales Netzwerk; Dienstanbieter: LinkedIn Ireland Unlimited Company, Wilton
            Place, Dublin 2, Irland; Website: <a href="https://www.linkedin.com" target="_blank">https://www.linkedin.com</a>;
          ...
          <li><strong>Twitter:</strong> Soziales Netzwerk; Dienstanbieter: Twitter International Company, One Cumberland
            Place, Fenian Street, Dublin 2 D02 AX07, Irland, Mutterunternehmen: Twitter Inc., 1355 Market Street, Suite
          ...
          <li><strong>Xing:</strong> Soziales Netzwerk; Dienstanbieter: XING AG, Dammtorstraße 29-32, 20354 Hamburg,
            ...
            Datenschutzerklärung: <a href="https://privacy.xing.com/de/datenschutzerklaerung" target="_blank">https://privacy.xing.com/de/datenschutzerklaerung</a>.
          </li>
        </ul>
        ...
        <ul class="m-elements">
          ...
          <li><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f. DSGVO), Einwilligung
            (Art. 6 Abs. 1 S. 1 lit. a. DSGVO), Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit.
            b. DSGVO).
          </li>
        </ul>
        <p><strong>Eingesetzte Dienste und Diensteanbieter:</strong></p>
        <ul class="m-elements">
          <li><strong>Google Fonts:</strong> Wir binden die Schriftarten ("Google Fonts") des Anbieters Google ein,
            wobei die Daten der Nutzer allein zu Zwecken der Darstellung der Schriftarten im Browser der Nutzer
            verwendet werden. Die Einbindung erfolgt auf Grundlage unserer berechtigten Interessen an einer technisch
            sicheren, wartungsfreien und effizienten Nutzung von Schriftarten, deren einheitlicher Darstellung sowie
            unter Berücksichtigung möglicher lizenzrechtlicher Restriktionen für deren Einbindung. Dienstanbieter:
            Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, Mutterunternehmen: Google LLC, 1600
            Amphitheatre Parkway, Mountain View, CA 94043, USA; Website: <a href="https://fonts.google.com/"
          ...
          <li><strong>YouTube-Videos:</strong> Videoinhalte; Dienstanbieter: Google Ireland Limited, Gordon House,
            ...
            94043, USA; Website: <a href="https://www.youtube.com" target="_blank">https://www.youtube.com</a>;
            Datenschutzerklärung: <a href="https://policies.google.com/privacy" target="_blank">https://policies.google.com/privacy</a>;
      ...
      <section class="data-protection--english">
        <h2 id="mEnglish">🇺🇸 Privacy policy</h2>
        <h2>Introduction</h2>
        <p>With the following data protection declaration, we would like to inform you about the types of your
          personal data (hereinafter also referred to as "data"), for what purposes and to what extent.
          purposes and to what extent. The data protection declaration applies to all processing carried out by us of
          personal data carried out by us, both in the context of the provision of our services and in particular on our
          websites, in mobile applications and within external online presences, such as our
          Social Media profiles (hereinafter collectively referred to as "Online Offerings").</p>
        <p>The terms used are not gender-specific.</p>
        <p>State: 15. September 2021</p>
        <h2>Table of contents</h2>
        <ul class="index">
          <li><a class="index-link" href="#m14">Introduction</a></li>
          <li><a class="index-link" href="#m3">Person in charge</a></li>
          <li><a class="index-link" href="#mOverview">Processing overview</a></li>
...
<!--          <li><a class="index-link" href="#m134">Einsatz von Cookies</a></li>-->
          ...
          <li><a class="index-link" href="#m104">Blogs and publication media</a></li>
          <li><a class="index-link" href="#m136">Presence in social networks (Social Media)</a></li>
          <li><a class="index-link" href="#m328">Plugins and embedded functions and content</a></li>
          <li><a class="index-link" href="#m15">Änderung und Aktualisierung der Datenschutzerklärung</a></li>
          <li><a class="index-link" href="#m10">Rights of the data subjects</a></li>
          <li><a class="index-link" href="#m42">Definitions of terms</a></li>
        </ul>
        <h2 id="m3">Person in charge</h2>
        <p>Ramona Schwering<br>Hochstraße 67<br>42105 Wuppertal</p>
        <p>E-Mail-address: hello@<span class="mail">schwering</span>ramona.codes<br/></p>
        <h2 id="mOverview">Processing overview</h2>
        <p>The following overview summarizes the types of data processed and the purposes of their processing
          and refers to the data subjects.</p>
        <h3>Arten der verarbeiteten Daten</h3>
        <ul>
<!--          <li>Bestandsdaten (z.B. Namen, Adressen).</li>-->
<!--          <li>Inhaltsdaten (z.B. Eingaben in Onlineformularen).</li>-->
<!--          <li>Kontaktdaten (z.B. E-Mail, Telefonnummern).</li>-->
        ...
        <ul>
          ...
          <li>User (z.B. Website visitors, users of online services).</li>
        </ul>
...
<!--          <li>Feedback (z.B. Sammeln von Feedback via Online-Formular).</li>-->
          ...
          <li>Savety measures.</li>
          <li>Provision of contractual services and customer service.</li>
          <li>Management and response to requests.</li>
        </ul>
        <h3 id="m13">Relevant legal bases</h3>
        <p>The following is an overview of the legal basis of the GDPR on which we process personal data.
          process personal data. Please note that, in addition to the provisions of the GDPR, national data protection
          data protection regulations in your or our country of residence or domicile may apply. If, furthermore, in individual cases
          more specific legal bases are relevant, we will inform you of these in the data protection declaration.</p>
        <ul>
          <li><strong>Consent (Art. 6 para. 1 p. 1 lit. a. DSGVO)</strong> - The data subject has given his/her
            Consent to the processing of personal data concerning him or her for a specific purpose
            or several specific purposes given.
          </li>
          <li><strong>
            Contract performance and pre-contractual requests (Art. 6 para. 1 p. 1 lit. b. DSGVO)</strong> - The
            processing is necessary for the performance of a contract to which the data subject is a party or for the
            performance of pre-contractual measures, which are carried out at the request of the data subject.
            The following is an overview of the legal basis of the GDPR on which we process personal data.
            process personal data. Please note that, in addition to the provisions of the GDPR, national data protection
            data protection regulations in your or our country of residence or domicile may apply. If, furthermore, in individual cases
            more specific legal bases are relevant, we will inform you of these in the data protection declaration.
          </li>
          <li><strong>Legitimate interests (Art. 6 para. 1 p. 1 lit. f. DSGVO)</strong> - The processing is necessary for the
            Safeguarding the legitimate interests of the controller or of a third party, unless the
            interests or fundamental rights and freedoms of the data subject, which require the protection of personal
            Data prevail.
          </li>
        </ul>
        <p><strong>National data protection regulations in Germany</strong>: In addition to the data protection regulations of the
          General Data Protection Regulation, national regulations on data protection apply in Germany. These include
          in particular the Act on Protection against Misuse of Personal Data in Data Processing
          (Federal Data Protection Act - BDSG). In particular, the BDSG contains special regulations on the right to information, the
          right to erasure, the right to object, the processing of special categories of personal data, processing for other
          processing for other purposes and for transmission and automated decision-making in individual cases, including profiling.
          including profiling. Furthermore, it regulates data processing for purposes of the
          employment relationship (Section 26 of the BDSG), in particular with regard to the establishment, performance or
          termination of employment relationships as well as the consent of employees. Furthermore
          State data protection laws of the individual federal states may also apply.</p>
        <h2 id="m27">Safety measures</h2>
        <p>We make decisions in accordance with the legal requirements, taking into account the state of the art, the
          implementation costs and the nature, scope, circumstances and purposes of the processing, as well as the different
        ...
        <p>The measures include, in particular, safeguarding the confidentiality, integrity and availability of
          data by controlling physical and electronic access to the data as well as the access, input, transfer, availability and separation of the data.
          access, entry, disclosure, availability assurance, and segregation. Furthermore, we have
          procedures in place to ensure the exercise of data subjects' rights, the deletion of data, and the response
          to the compromise of data. Furthermore, we take the protection of personal data into account
          already taken into account in the development and selection of hardware, software and processes in accordance with the principle of
          data protection, through technology design and through data protection-friendly default settings.</p>
        <h2 id="m25">Transmission of personal data</h2>
        <p>In the course of our processing of personal data, it happens that the data is transmitted to other entities,
          ...
          agreements that serve the protection of your data with the recipients of your data.</p>
        <h2 id="m24">Data processing in third countries</h2>
        <p>If we process data in a third country (i.e., outside of the European Union (EU), the European
          Economic Area (EEA)) or the processing takes place in the context of the use of third-party services or the disclosure
          or the disclosure or transfer of data to other persons, entities or companies takes place,
          this shall only take place in accordance with the statutory requirements. </p>
        <p>Subject to express consent or contractually or legally required transfer
          we process the data or have it processed only in third countries with a recognized level of data protection,
          contractual obligation through so-called standard protection clauses of the EU Commission, in the presence of
          certifications or binding internal data protection regulations (Art. 44 to 49 DSGVO,
          Information page of the EU Commission: <a
            href="https://ec.europa.eu/info/law/law-topic/data-protection/international-dimension-data-protection_de"
            target="_blank">https://ec.europa.eu/info/law/law-topic/data-protection/international-dimension-data-protection_de</a>).
        </p>
        <h2 id="m12">Data deletion</h2>
        <p>
          ...
          purpose of processing this data has ceased to apply or it is not required for the purpose).
          Data processing in third countries
        </p>
        <p>If the data are not deleted because they are required for other and legally permissible purposes
          their processing will be limited to these purposes. I.e., the data is blocked and not processed for other
          processed for other purposes. This applies, for example, to data that has to be retained for reasons of commercial or tax law
          or whose storage is necessary for the assertion, exercise or defense of legal claims or for the
        ...
        <p>In order to be able to provide our online offer securely and efficiently, we make use of the services of one or more
          ...
          Online Offer can be accessed. For these purposes, we may use infrastructure and
          platform services, computing capacity, storage space and database services as well as security and technical
          technical maintenance services. The collection of data for the
          provision and use of the website and the processing of the data via an external
          hosting service provider is absolutely necessary for the operation of the website. The legal basis for
          processing is Art. 6 para. 1 p. 1 lit. f DSGVO.</p>
        <p>The data processed in the course of providing the hosting service may include all data relating to the users of our online service.
          online offer, which accrue in the course of use and communication. This
          IP address, which is necessary to deliver the contents of online offers to browsers, and all information
          browser, and all entries made within our online offer or from websites.</p>.
        <p>For hosting our website, we currently use the services of www.netlify.com (Netlify, Inc., 2325
          3rd Street, Suite 215, San Francisco, 94107 CA). Netlify's servers are located in the USA. Therefore
          your data required for calling up the website (access data) is transmitted to the USA.
          The legal basis for the transmission is Art. 6 para. 1 p. 1 lit. f DSGVO.

          In order to ensure the protection of your personal rights also in the context of these data transfers, we make use of
          contractual relationships with Netlify, we make use of the standard contractual clauses of the
          EU Commission in accordance with Art. 46 para. 2 lit. c) DSGVO. These are available at
          https://www.netlify.com/legal/netlify-dpa.pdf, alternatively you can also request these documents from us by
          using the contact details below.

          You can object to the processing at any time. Please note the above information on your
          your right to object to this data protection declaration. You can send your objection
          to us as well as directly to Netlify.</p>
        <p><strong>Collection of access data and log files</strong>: We ourselves (or rather our web hosting provider) collect
          data on each access to the server (so-called server log files). The server log files may include the address
          and name of the requested web pages and files, date and time of the request, amount of data transferred, message about
          successful retrieval, browser type and version, the operating system of the user, referrer URL (the previously visited
          visited page) and usually IP addresses and the requesting provider belong.</p>.
        <p>The server log files may be used on the one hand for security purposes, e.g., to avoid overloading
          servers (especially in the case of abusive attacks, so-called DDoS attacks) and, on the
          on the other hand, to ensure the utilization of the servers and their stability.</p>
        <ul class="m-elements">
          <li><strong>Types of data processed:</strong> Content data (e.g. entries in online forms), usage data
        ...
        <p>We use blogs or comparable means of online communication and publication (hereinafter referred to as the
          "publication medium"). The data of the readers are processed for the purposes of the publication medium only insofar
          only insofar as it is necessary for its presentation and the communication between authors and readers or for reasons of
          necessary for security reasons. For the rest, we refer to the information on the processing of visitors to
          of our publication medium within the framework of this data protection notice.</p>.
        <p><strong>Comments and Contributions</strong>: When users leave comments or other contributions, we may
          have their IP addresses stored based on our legitimate interests. This is done for our
          security, in case someone leaves illegal content in comments and posts (insults,
          forbidden political propaganda, etc.). In this case, we can be prosecuted ourselves for the comment or post and are therefore
          and are therefore interested in the identity of the author.</p>
        <p>Furthermore, we reserve the right, on the basis of our legitimate interests, to process the information of users
          for the purpose of spam detection.</p>
        <p>On the same legal basis, we reserve the right, in the case of surveys, to store the IP addresses of users for the duration of the survey and to use cookies.
          duration and to use cookies in order to avoid multiple votes.</p>
        <p>The personal information provided in the context of comments and contributions, any contact and
          Website information as well as the content information will be stored by us until the objection of the user.
          permanently stored.</p>
        <ul class="m-elements">
          <li><strong>Verarbeitete Datenarten:</strong> Inventory data (e.g. names, addresses), contact data (e.g. e-mail,
          ...
          <li><strong>Affected persons:</strong> Users (e.g. website visitors, users of online services).</li>
          <li><strong>Purposes of processing:</strong> provision of contractual services and customer service, feedback.
            (e.g. collecting feedback via online form), security measures, administration and responding to
            requests.
          </li>
          <li><strong>Legal basis:</strong> Contract performance and pre-contractual requests (Art. 6 para. 1 p. 1 lit.
            b. DSGVO), Legitimate Interests (Art. 6 para. 1 p. 1 lit. f. DSGVO).
          </li>
        </ul>
        <h2 id="m136">Presence in social networks (Social Media)</h2>
        <p>We maintain online presences within social networks and in this context process data of the
          users in order to communicate with the users active there or to offer information about us.</p>
        <p>We would like to point out that user data may be processed outside the European Union.
          can be processed. This may result in risks for the users, because, for example, the enforcement of the rights
          of the users could be made more difficult.</p>
        <p>Furthermore, the data of users within social networks are usually processed for market research and
          Advertising purposes processed. Thus, for example, on the basis of the usage behavior and resulting interests
          of the users can be used to create usage profiles. The usage profiles can in turn be used, for example, to
          advertisements within and outside the networks that are presumed to correspond to the interests of the users.
          correspond to the interests of the users. For these purposes, cookies are usually stored on the users' computers, in which
          the usage behavior and interests of the users are stored. Furthermore, the usage profiles may also contain
          data may also be stored in the usage profiles irrespective of the devices used by the users (in particular, if the users are
          are members of the respective platforms and are logged in to them).</p>
        <p>For a detailed presentation of the respective forms of processing and the possibilities of objection
          (opt-out), we refer to the privacy statements and information provided by the operators of the respective networks.</p>.
        <p>Also in the case of requests for information and the assertion of data subject rights, we would like to point out that
          these can be asserted most effectively with the providers. Only the providers have access to the
          to the users' data and can take appropriate measures and provide information directly. Should you
          still need help, then you can contact us.</p>
        <ul class="m-elements">
          <li><strong>Types of data processed:</strong> Contact data (e.g. e-mail, telephone numbers), content data (e.g..
            Entries in online forms), usage data (e.g. websites visited, interest in content,
            access times), meta/communication data (e.g. device information, IP addresses).
          </li>
          <li><strong>Affected persons:</strong> Users (e.g. website visitors, users of online services).
          <li><strong>Purposes of processing:</strong> contact requests and communication, feedback (e.g. collecting.
        ...
        <ul class="m-elements">
          <li><strong>LinkedIn:</strong> social network; service provider: LinkedIn Ireland Unlimited Company, Wilton
            Place, Dublin 2, Ireland; website: <a href="https://www.linkedin.com" target="_blank">https://www.linkedin.com</a>;
            Privacy Policy: <a href="https://www.linkedin.com/legal/privacy-policy" target="_blank">https://www.linkedin.com/legal/privacy-policy</a>;
            Opt-out: <a
              href="https://www.linkedin.com/psettings/guest-controls/retargeting-opt-out" target="_blank">https://www.linkedin.com/psettings/guest-controls/retargeting-opt-out</a>.
          </li>
          <li><strong>Twitter:</strong> social network; service provider: Twitter International Company, One Cumberland
            Place, Fenian Street, Dublin 2 D02 AX07, Ireland, parent company: Twitter Inc, 1355 Market Street, Suite.
            900, San Francisco, CA 94103, USA; privacy policy: <a href="https://twitter.com/de/privacy"
                                                                  target="_blank">https://twitter.com/de/privacy</a>,
            (settings) <a href="https://twitter.com/personalization" target="_blank">https://twitter.com/personalization</a>.
          </li>
          <li><strong>Xing:</strong> social network; service provider: XING AG, Dammtorstraße 29-32, 20354 Hamburg,
            Germany; Website: <a href="https://www.xing.de" target="_blank">https://www.xing.de</a>;
            Privacy policy: <a href="https://privacy.xing.com/de/datenschutzerklaerung" target="_blank">https://privacy.xing.com/de/datenschutzerklaerung</a>.
          </li>
        </ul>
        <h2 id="m328">Plugins and embedded functions and content</h2>
        <p>We include in our online offer functional and content elements that are obtained from the servers of their respective
          providers (hereinafter referred to as "third-party providers"). These can be, for example.
          Graphics, videos or city maps act (hereinafter uniformly referred to as "content").</p>.
        <p>The integration always requires that the third party providers of this content process the IP address of the users
          process, since without the IP address they could not send the content to their browser. The IP address is
          thus necessary for the presentation of these contents or functions. We endeavor to use only such content
          ...
          for statistical or marketing purposes. The "pixel tags" can be used to collect information such as the
          visitor traffic on the pages of this website, can be evaluated. The pseudonymous information can
          also be stored in cookies on the user's device and contain, among other things, technical information about the
          browser and operating system, referring websites, time of visit and other information about the use of our online
          of our online offer as well as be linked to such information from other sources.</p>.
        <p><strong>Notes on legal basis:</strong> Insofar as we ask users for their consent to use the
          Third Party Providers, the legal basis for the processing of data is consent. Otherwise
          the users' data on the basis of our legitimate interests (i.e. interest in efficient,
          economic and recipient-friendly services) are processed. In this context, we would like to
          also refer to the information on the use of cookies in this privacy policy.</p>.
        <ul class="m-elements">
          <li><strong>Types of data processed:</strong> Usage data (e.g. websites visited, interest in content,
            access times), meta/communication data (e.g. device information, IP addresses), inventory data (e.g.
            names, addresses), contact data (e.g. e-mail, telephone numbers), content data (e.g. entries in
            online forms).
          </li>
          <li><strong>Affected persons:</strong> Users (e.g. website visitors, users of online services).
          <li><strong>Purposes of processing:</strong> Provision of our online offer and user friendliness,
          ...
          <li><strong>Legal basis:</strong> Legitimate interests (Art. 6 para. 1 p. 1 lit. f. DSGVO), consent.
            (Art. 6 para. 1 p. 1 lit. a. DSGVO), contract performance and pre-contractual requests (Art. 6 para. 1 p. 1 lit.
            b. DSGVO).
          </li>
        </ul>
        <p><strong>Services used and service providers</strong></p>
        <ul class="m-elements">
          <li><strong>Google Fonts:</strong> We integrate the fonts ("Google Fonts") of the provider Google,
            whereby the data of the user solely for the purpose of displaying the fonts in the user's browser
            are used. The integration is based on our legitimate interests in a technically
            safe, maintenance-free and efficient use of fonts, their uniform display and the possible
            taking into account possible restrictions under licensing law for their integration. Service provider:
          ...
          <li><strong>YouTube videos:</strong> video content; service provider: Google Ireland Limited, Gordon House,
            Barrow Street, Dublin 4, Ireland, parent company: Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA.
            94043, USA; website: <a href="https://www.youtube.com" target="_blank">https://www.youtube.com</a>;
            Privacy Policy: <a href="https://policies.google.com/privacy" target="_blank">https://policies.google.com/privacy</a>;
            Opt-out: opt-out plugin: <a href="https://tools.google.com/dlpage/gaoptout?hl=de"
                                        target="_blank">https://tools.google.com/dlpage/gaoptout?hl=de</a>,
            Ad display settings: <a
              href="https://adssettings.google.com/authenticated" target="_blank">https://adssettings.google.com/authenticated</a>.
          </li>
        </ul>
        <h2 id="m15">Modification and update of the privacy policy</h2>
        <p>We ask you to regularly check the content of our privacy policy. We adapt the
          Privacy Policy as soon as the changes in the data processing carried out by us make this necessary.
          make this necessary. We will inform you as soon as the changes require an act of cooperation on your part
          (e.g. consent) or other individual notification is required.</p>.
        <p>Where we provide addresses and contact information of companies and
          organizations, we ask you to note that addresses may change over time and ask you to review the
          to verify the information before contacting us.</p>
        <h2 id="m10">Rights of the data subjects</h2>
        <p>As a data subject, you are entitled to various rights under the GDPR, which arise in particular from Art. 15 to 21
          GDPR:</p>
        <ul>
          <li><strong>Right to object: You have the right to object, on grounds relating to your particular situation
            object at any time to the processing of personal data relating to you which is carried out on the basis of
            Article 6 (1) lit. e or f DSGVO; this also applies to profiling based on these provisions.
            Provisions based profiling. If the personal data concerning you is processed for the purpose of
            direct marketing, you have the right to object at any time to the processing of your
            personal data concerning you for the purpose of such advertising; this also applies to profiling, insofar as it is related to such
            profiling, insofar as it is related to such direct marketing.</strong></li>
          <li><strong>Right of revocation for consents:</strong> You have the right to revoke consents granted at any time.
            to revoke.
          </li>
          <li><strong>Right of access:</strong> You have the right to ask for confirmation as to whether
            relevant data are processed and to information about these data as well as further information and
          ...
          <li>
            <strong>Right to erasure and restriction of processing:</strong> You have in accordance with the
            legal requirements, the right to demand that data relating to you be deleted without delay or, alternatively
            alternatively, in accordance with the legal requirements, to restrict the processing of the data.
            demand.
          ...
          <li><strong>Right to data portability:</strong> You have the right to request data concerning you that you have provided to us
          ...
          <li><strong>Complaint to supervisory authority:</strong> You have, without prejudice to any other
            ...
            personal data is in breach of the requirements of the GDPR.
          </li>
        </ul>
        <h2 id="m42">Definition of terms</h2>
        <p>This section provides you with an overview of the terms used in this privacy statement.
          Terminology. Many of the terms are taken from the law and defined primarily in Art. 4 of the GDPR. The
          legal definitions are binding. The following explanations, on the other hand, are intended primarily for
          understanding serve. The terms are sorted alphabetically.</p>
        <ul class="glossary">
          <li><strong>Personal Data:</strong> "Personal Data" means any information relating to.
            an identified or identifiable natural person (hereinafter referred to as "data subject"); an
            identifiable is a natural person who can be identified, directly or indirectly, in particular by means of an
            association with an identifier such as a name, an identification number, location data, an online identifier
            (e.g. cookie) or to one or more special characteristics that are an expression of the physical, physiological, genetic or mental characteristics of the person.
            physical, physiological, genetic, mental, economic, cultural or social identity of that natural
            of this natural person.
          </li>
          <li><strong>Responsible:</strong> As "responsible person" is the natural or legal person,
            authority, agency or other body which alone or jointly with others determines the purposes and means
            of the processing of personal data.
          </li>
          <li><strong>Processing:</strong> "Processing" shall mean any operation or set of operations which is performed with or
            performed with or without the aid of automated procedures or any such series of procedures in connection with personal data. The term
            ranges widely and includes virtually any handling of data, be it collection, evaluation, storage,
