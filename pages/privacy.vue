  ...
  <Page title="Data Protection">
    <main class="index">
      <section>
        <div class="data-protection__inner">
          <div class="data-protection__text">
            <p class="data-protection__sub-title">
              English translation below. <span class="hint">Jump to the <a
                class="index-link"
                href="#mEnglish"
              >translation</a> directly</span>
            </p>
          </div>
        </div>
        <div class="gradient" />
      ...
      <section class="data-protection--german">
        ...
        <p>
          Cookies sind Textdateien, die Daten von besuchten Websites oder Domains enthalten und von einem Browser auf
          ...
          pseudonymer Onlinekennzeichnungen gespeichert werden, auch als "Nutzer-IDs" bezeichnet)
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>Notwendige (auch: essentielle oder unbedingt erforderliche) Cookies:</strong> Cookies können zum
          ...
          <li>
            <strong>Statistik-, Marketing- und Personalisierungs-Cookies</strong>: Ferner werden Cookies im Regelfall
        ...
        <p>
          <strong>Hinweise zu Rechtsgrundlagen: </strong> Auf welcher Rechtsgrundlage wir Ihre personenbezogenen Daten
        ...
        <p>
          <strong>Speicherdauer: </strong>Sofern wir Ihnen keine expliziten Angaben zur Speicherdauer von permanenten
        ...
        <p>
          <strong>Allgemeine Hinweise zum Widerruf und Widerspruch (Opt-Out): </strong> Abhängig davon, ob die
        ...
        <p>
          ...
          Verarbeitung ist Art. 6 Abs. 1 S. 1 lit. f DSGVO.
        </p>
        <p>
        ...
        <p>
          Für das Hosting unserer Webseite verwenden wir momentan die Dienste von www.netlify.com (Netlify, Inc., 2325
          ...
          sowohl an uns als auch direkt an Netlify wenden.
        </p>
        <p>
        ...
        <ul class="m-elements">
          ...
          <li><strong>Betroffene Personen:</strong> Nutzer (z.B. Webseitenbesucher, Nutzer von Onlinediensten).</li>
          <li>
            <strong>Zwecke der Verarbeitung:</strong> Erbringung vertraglicher Leistungen und Kundenservice, Feedback
        ...
        <ul class="m-elements">
          <li>
            ...
            Place, Dublin 2, Irland; Website: <a
          ...
          <li>
            <strong>Twitter:</strong> Soziales Netzwerk; Dienstanbieter: Twitter International Company, One Cumberland
            Place, Fenian Street, Dublin 2 D02 AX07, Irland, Mutterunternehmen: Twitter Inc., 1355 Market Street, Suite
            900, San Francisco, CA 94103, USA; Datenschutzerklärung: <a
        ...
        <ul class="m-elements">
          <li>
            <strong>Google Fonts:</strong> Wir binden die Schriftarten ("Google Fonts") des Anbieters Google ein,
          ...
          <li>
            <strong>YouTube-Videos:</strong> Videoinhalte; Dienstanbieter: Google Ireland Limited, Gordon House,
        ...
        <ul>
          <li>
            <strong>Widerspruchsrecht: Sie haben das Recht, aus Gründen, die sich aus Ihrer besonderen Situation
        ...
        <ul class="glossary">
          <li>
            <strong>Personenbezogene Daten:</strong> "Personenbezogene Daten“ sind alle Informationen, die sich auf
      ...
      <section class="data-protection--english">
        ...
        <p>
          ...
          Social Media profiles (hereinafter collectively referred to as "Online Offerings").
        </p>
        ...
        <ul class="index">
          ...
          <li>
            <a
              class="index-link"
              href="#m225"
            >Provision of the online offer and web hosting</a>
          </li>
          <li>
            <a
              class="index-link"
              href="#m104"
            >Blogs and publication media</a>
          </li>
          <li>
            <a
              class="index-link"
              href="#m136"
            >Presence in social networks (Social Media)</a>
          </li>
          <li>
            <a
              class="index-link"
        ...
        <ul>
          <li>
            <strong>Consent (Art. 6 para. 1 p. 1 lit. a. DSGVO)</strong> - The data subject has given his/her
          ...
          <li>
            <strong>Legitimate interests (Art. 6 para. 1 p. 1 lit. f. DSGVO)</strong> - The processing is necessary for the
        ...
        <p>
          <strong>National data protection regulations in Germany</strong>: In addition to the data protection regulations of the
        ...
        <p>
          We make decisions in accordance with the legal requirements, taking into account the state of the art, the
        ...
        <p>
          Our data protection notices may also contain further information on the retention and deletion of data.
        ...
        <p>
          Cookies are text files that contain data from visited websites or domains and are stored on the user's computer by a browser.
          ...
          pseudonymous online identifiers are stored, also referred to as "user IDs")
        </p>
        <p><strong>The following cookie types and functions are distinguished:</strong></p>
        <ul>
          <li>
            <strong>Temporary cookies (also: session cookies or session cookies):</strong>&nbsp;Temporary cookies are
            deleted at the latest after a user has left an online offer and closed his browser.
          </li>
          <li>
            <strong>Permanent Cookies:</strong>&nbsp;Permanent cookies remain stored even after closing the browser.
          ...
          <li>
            <strong>Third-Party-Cookies (auch: Drittanbieter-Cookies)</strong>: Third-party cookies are
            mainly used by advertisers (so-called third parties) to process user information.
          </li>
          <li>
            <strong>Necessary (also: essential or absolutely necessary) cookies:</strong> Cookies can be
            may be absolutely necessary for the operation of a website (e.g. to store logins or other user input
            or for security reasons).
          </li>
          <li>
            <strong>Statistical, marketing and personalization cookies</strong>: Furthermore, cookies are usually
        ...
        <p>
          <strong>Hinweise zu Rechtsgrundlagen: </strong> The legal basis on which we process your personal data
        ...
        <p>
          <strong>Save duration: </strong>If we do not provide you with any explicit information on the storage period of permanent
        ...
        <p>
          <strong>General information on revocation and objection (Opt-Out): </strong> Depending on whether the
          ...
          of services, especially in the case of tracking, via the websites. <a
            href="https://optout.aboutads.info"
            target="_blank"
          >https://optout.aboutads.info</a>
          and <a
        ...
        <p>
          <strong>Processing of cookie data on the basis of consent</strong>: We use a cookie consent management procedure.
          ...
          cookies and/or service providers) as well as the browser, system and end device used are stored..
        </p>
        <ul class="m-elements">
          <li>
            <strong>Types of data processed:</strong> N
          ...
          <li>
            <strong>Legal basis:</strong> Consent (Art. 6 para. 1 p. 1 lit. a. DSGVO), Legitimate Interests
        ...
        <p>
          In order to be able to provide our online offer securely and efficiently, we make use of the services of one or more
        ...
        <p>
          The data processed in the course of providing the hosting service may include all data relating to the users of our online service.
        ...
        <p>
          For hosting our website, we currently use the services of www.netlify.com (Netlify, Inc., 2325
          ...
          to us as well as directly to Netlify.
        </p>
        <p>
          <strong>Collection of access data and log files</strong>: We ourselves (or rather our web hosting provider) collect
          ...
          visited page) and usually IP addresses and the requesting provider belong.
        </p>.
        <p>
          The server log files may be used on the one hand for security purposes, e.g., to avoid overloading
          servers (especially in the case of abusive attacks, so-called DDoS attacks) and, on the
          on the other hand, to ensure the utilization of the servers and their stability.
        </p>
        <ul class="m-elements">
          <li>
            <strong>Types of data processed:</strong> Content data (e.g. entries in online forms), usage data
          ...
          <li>
            <strong>Purposes of processing:</strong> provision of our online offer and user friendliness.
          </li>
        ...
        <p>
          We use blogs or comparable means of online communication and publication (hereinafter referred to as the
          ...
          of our publication medium within the framework of this data protection notice.
        </p>.
        <p>
          <strong>Comments and Contributions</strong>: When users leave comments or other contributions, we may
        ...
        <p>
          Furthermore, we reserve the right, on the basis of our legitimate interests, to process the information of users
          for the purpose of spam detection.
        </p>
        <p>
          On the same legal basis, we reserve the right, in the case of surveys, to store the IP addresses of users for the duration of the survey and to use cookies.
          duration and to use cookies in order to avoid multiple votes.
        </p>
        <p>
          The personal information provided in the context of comments and contributions, any contact and
          Website information as well as the content information will be stored by us until the objection of the user.
          permanently stored.
        </p>
        <ul class="m-elements">
          <li>
            <strong>Verarbeitete Datenarten:</strong> Inventory data (e.g. names, addresses), contact data (e.g. e-mail,
          ...
          <li><strong>Affected persons:</strong> Users (e.g. website visitors, users of online services).</li>
          <li>
            <strong>Purposes of processing:</strong> provision of contractual services and customer service, feedback.
            (e.g. collecting feedback via online form), security measures, administration and responding to
            requests.
          </li>
          <li>
            <strong>Legal basis:</strong> Contract performance and pre-contractual requests (Art. 6 para. 1 p. 1 lit.
        ...
        <p>
          We maintain online presences within social networks and in this context process data of the
          users in order to communicate with the users active there or to offer information about us.
        </p>
        <p>
          ...
          of the users could be made more difficult.
        </p>
        <p>
          Furthermore, the data of users within social networks are usually processed for market research and
        ...
        <p>
          ...
          (opt-out), we refer to the privacy statements and information provided by the operators of the respective networks.
        </p>.
        <p>
          Also in the case of requests for information and the assertion of data subject rights, we would like to point out that
        ...
        <ul class="m-elements">
          <li>
            <strong>Types of data processed:</strong> Contact data (e.g. e-mail, telephone numbers), content data (e.g..
            Entries in online forms), usage data (e.g. websites visited, interest in content,
            access times), meta/communication data (e.g. device information, IP addresses).
          </li>
          <li>
            <strong>Affected persons:</strong> Users (e.g. website visitors, users of online services).
          </li><li>
            <strong>Purposes of processing:</strong> contact requests and communication, feedback (e.g. collecting.
        ...
        <ul class="m-elements">
          <li>
            <strong>LinkedIn:</strong> social network; service provider: LinkedIn Ireland Unlimited Company, Wilton
            Place, Dublin 2, Ireland; website: <a
              href="https://www.linkedin.com"
              target="_blank"
            >https://www.linkedin.com</a>;
            Privacy Policy: <a
          ...
          <li>
            <strong>Twitter:</strong> social network; service provider: Twitter International Company, One Cumberland
            Place, Fenian Street, Dublin 2 D02 AX07, Ireland, parent company: Twitter Inc, 1355 Market Street, Suite.
            900, San Francisco, CA 94103, USA; privacy policy: <a
              href="https://twitter.com/de/privacy"
              target="_blank"
            >https://twitter.com/de/privacy</a>,
            (settings) <a
          ...
          <li>
            <strong>Xing:</strong> social network; service provider: XING AG, Dammtorstraße 29-32, 20354 Hamburg,
            Germany; Website: <a
              href="https://www.xing.de"
              target="_blank"
            >https://www.xing.de</a>;
        ...
        <p>
          We include in our online offer functional and content elements that are obtained from the servers of their respective
          providers (hereinafter referred to as "third-party providers"). These can be, for example.
          Graphics, videos or city maps act (hereinafter uniformly referred to as "content").
        </p>.
        <p>
          The integration always requires that the third party providers of this content process the IP address of the users
          ...
          of our online offer as well as be linked to such information from other sources.
        </p>.
        <p>
          <strong>Notes on legal basis:</strong> Insofar as we ask users for their consent to use the
          ...
          also refer to the information on the use of cookies in this privacy policy.
        </p>.
        <ul class="m-elements">
          <li>
          ...
          <li>
            <strong>Legal basis:</strong> Legitimate interests (Art. 6 para. 1 p. 1 lit. f. DSGVO), consent.
        ...
        <ul class="m-elements">
          <li>
            <strong>Google Fonts:</strong> We integrate the fonts ("Google Fonts") of the provider Google,
          ...
          <li>
            <strong>YouTube videos:</strong> video content; service provider: Google Ireland Limited, Gordon House,
        ...
        <p>
          We ask you to regularly check the content of our privacy policy. We adapt the
        ...
        <p>
          ...
          to verify the information before contacting us.
        </p>
        <h2 id="m10">
        ...
        <ul>
          <li>
            <strong>Right to object: You have the right to object, on grounds relating to your particular situation
              ...
              profiling, insofar as it is related to such direct marketing.</strong>
          </li>
          <li>
            <strong>Right of revocation for consents:</strong> You have the right to revoke consents granted at any time.
            to revoke.
          </li>
          <li>
            <strong>Right of access:</strong> You have the right to ask for confirmation as to whether
          ...
          <li>
            <strong>Right to rectification:</strong> You have the right, in accordance with the law, to request the
          ...
          <li>
            <strong>Right to data portability:</strong> You have the right to request data concerning you that you have provided to us
          ...
          <li>
            <strong>Complaint to supervisory authority:</strong> You have, without prejudice to any other
        ...
        <p>
          ...
          understanding serve. The terms are sorted alphabetically.
        </p>
        <ul class="glossary">
          <li>
            <strong>Personal Data:</strong> "Personal Data" means any information relating to.
          ...
          <li>
            <strong>Responsible:</strong> As "responsible person" is the natural or legal person,
            authority, agency or other body which alone or jointly with others determines the purposes and means
            of the processing of personal data.
          </li>
          <li>
            <strong>Processing:</strong> "Processing" shall mean any operation or set of operations which is performed with or
